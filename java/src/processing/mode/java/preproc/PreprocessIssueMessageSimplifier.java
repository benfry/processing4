...
public class PreprocessIssueMessageSimplifier {
  ...
  protected static class EvenCountTemplateMessageSimplifierStrategy
    ...
    /**
     * Simplifies a message based on a given String input and line number.
     * @param message the message generated by ANTLR
     * @param line the line number the error occured on 
     * @return returns an optional object containing an instance of PdeIssueEmitter.IssueMessageSimplification or an empty value.
     */
    @Override
