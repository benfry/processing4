...
public abstract class FrameBasedSurface extends PSurfaceNone {
...
//      useStrategy = false;
    ...
    */
    ...
    protected abstract void initalizeCanvas();
...
//    sketch.setFrame(frame);
    ...
    protected abstract void addCanvas(Frame frame);
...
*/
    ...
    protected abstract void requestCanvasFocus();
...
//    }
    ...
    protected abstract void setCanvasBounds(int contentWidth, int contentHeight, int sketchWidth, int sketchHeight);
...
//    new Exception().printStackTrace(System.out);
        ...
        setCanvasBounds(contentW, contentH, sketchWidth, sketchHeight);
    }
...
//       InputEvent.ALT_DOWN_MASK);
    ...
    protected abstract void addMouseWheelListener(MouseWheelListener listener);
    protected abstract void addKeyListener(KeyListener listener);
    protected abstract void addFocusListener(FocusListener listener);
...
//  }
    ...
    public void setCursor(PImage img, int x, int y) {
        ...
        Cursor cursor = createCursor(img, x, y, "custom");
        setCursor(cursor);
        cursorVisible = true;
    }

    protected Cursor createCursor(PImage image, int x, int y, String name) {
        return createCursor((Image) image.getNative(), x, y, name);
    }

    protected abstract void setCursor(Cursor cursor);
    protected abstract Cursor createCursor(Image image, int x, int y, String name);
    ...
    public void hideCursor() {
        ...
        if (invisibleCursor == null) {
            ...
            if (cursorSize.width == 0 || cursorSize.height == 0) {
                ...
                invisibleCursor = createCursor(cursorImg, 8, 8, "blank");
            }
        }
